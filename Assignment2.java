...
public class Assignment2 { 
	...
	public static int[][] ResidualGraph(int[][] OriginalGraph)
	{

		int[][] Residual_Graph = new int[OriginalGraph.length][OriginalGraph.length];
		for(int i=0;i<OriginalGraph.length ; i++)
		{
			for(int j=0;j<OriginalGraph.length ; j++)
			{
				Residual_Graph[i][j] = OriginalGraph[i][j];
			}
		}
	...
	private static void GraphMinCut(int[][] OriginalGraph, int source, int destination) { 
		int node1,node2;
		int [][] ResidualGraph = ResidualGraph(OriginalGraph);ResidualGraph(OriginalGraph);
    ...
    { 
        ...
        int [][] ResidualGraph = ResidualGraph(OriginalGraph);
        int[] parent = new int[OriginalGraph.length]; 
	...
	{ 
	    ...
	    Assignment2.GraphMinCut(OriginalGraph_given, 0, 5);
		System.out.println(" ");
		System.out.println(" ");
		...
		Assignment2.GraphMinCut(OriginalGraph_max, 0, 5);
